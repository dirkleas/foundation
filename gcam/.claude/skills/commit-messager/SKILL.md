...
> **IMPORTANT**: Output raw plain text only. NEVER add Claude attribution, Co-Authored-By lines, markdown formatting, or code fences.
...
These examples show the exact plain text output (no fences in actual output):
